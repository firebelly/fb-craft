...
class FbWidgets_FbWidgetsWidget extends BaseWidget
{
    // Properties
    // =========================================================================
    ...
    {
        return Craft::t('FB Recent Entries');
    }
    ...
    public function getTitle()
    {
        ...
        if (is_numeric($sectionId))
        {
            ...
            if ($section)
            {
                $title = Craft::t('FB Recent {section} Entries', array(
        ...
        if (!isset($title))
        {
            $title = Craft::t('FB Recent Entries');
        }
    ...
    public function getBodyHtml()
    {
        ...
        return craft()->templates->render('fbwidgets/body', array(
            'entries' => $entries
        ));
    }
