...
$.gdgr.main = (function() {
  ...
  function _initTypeTester() {
    ...
    if ($('.type-tester').length) {
      ...
      // Set Up Tools
      $typeTester.prepend('<div id="typetools"><div class="typetools-container"><div class="tools-top"><h3>Type Tester</h3></div></div></div>');
      var $tools = $('#typetools');
      ...
      if ($typeTester.attr('data-svg-url')) {
        ...
        $toolsContainer.find('.tools-top').append('<div class="type-tool" id="glyphsTypeToggle"><button id="glyphsToggle" class="-active" data-target="#glyphChart">Glyphs</button><button id="typeToggle" data-target=".test-para">Type</button></div>');
